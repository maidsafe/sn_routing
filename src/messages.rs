...
impl UserMessage {
    ...
    fn is_cacheable(&self) -> bool {
        match *self {
            UserMessage::Request(Request::Get(DataIdentifier::Immutable(..), _)) |
            UserMessage::Response(Response::GetSuccess(Data::Immutable(..), _)) => true,
            _ => false
        }
    }
}
...
/// This assembles UserMessages from UserMessageParts.
