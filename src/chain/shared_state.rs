...
use crate::{
    ...
    section::{
        AgeCounter, EldersInfo, MemberState, SectionKeyInfo, SectionMembers, SectionProofBlock,
        SectionProofChain,
    },
    Prefix, XorName,
};
...
impl SharedState {
    ...
    // possible.
    pub fn check_and_clean_neighbour_infos(&mut self) {
