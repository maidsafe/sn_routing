...
pub mod compat {
    ...
    impl Service {
        ...
        pub fn restart(&self, event_sender: CrustEventSender, uid: SecretId) {
        ...
        pub fn disconnect(&self, uid: &PublicId) -> bool {
            self.lock().disconnect(uid)
        }

        /// Send message to the given peer.
        // TODO: Implement tests that drop low-priority messages.
        pub fn send(&self, uid: &PublicId, data: Vec<u8>, _priority: u8) -> Result<(), CrustError> {
