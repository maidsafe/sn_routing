            ...
            UserMessage::Response(ref response) => {
                match *response {
                    ...
                    Response::ListMDataUserPermissions { ref res, .. } => {
                        self.msg_list_mdata_user_permissions.inc_response(res.is_ok())
                    }
                    Response::SetMDataUserPermissions { ref res, .. } => {
                        self.msg_set_mdata_user_permissions.inc_response(res.is_ok())
                    }
                    Response::DelMDataUserPermissions { ref res, .. } => {
                        self.msg_del_mdata_user_permissions.inc_response(res.is_ok())
                    }
                    ...
                    Response::ListAuthKeysAndVersion { ref res, .. } => {
                        self.msg_list_auth_keys_and_version.inc_response(res.is_ok())
                    }
