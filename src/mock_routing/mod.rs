...
impl MockRouting {
    ...
    pub fn get_request(&self,
        ...
        unwrap_result!(self.pimpl.lock()).get_request(our_authority, location, request_for)
    }
    ...
    pub fn get_response(&self,
        ...
        unwrap_result!(self.pimpl.lock()).get_response(our_authority, location, data, data_request, response_token)
    }
    ...
    pub fn put_request(&mut self,
                       ...
                       location: ::routing::Authority,
                       data: ::routing::data::Data) {
        unwrap_result!(self.pimpl.lock()).put_request(our_authority, location, data)
    }
    ...
    pub fn put_response(&self,
        ...
        unwrap_result!(self.pimpl.lock()).put_response(our_authority, location, response_error, signed_token)
    }
    ...
    pub fn refresh_request(&self,
                           ...
                           content: Vec<u8>,
                           churn_node: XorName) {
        unwrap_result!(self.pimpl.lock()).refresh_request(type_tag, our_authority, content, churn_node)
    }
