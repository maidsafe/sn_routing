...
// use rand::Rng;
// use routing::{
//     Authority, Event, EventStream, FullId, MessageId, Node,
...
//                         if let Request::Vault( .., msg_id) = request {
//                             let node = &mut nodes[index].node;
//                             unwrap!(node.send_response(dst, src, Ok(()), msg_id));
//                         }
//                     }
//
//                     TestEvent(
...
//                             response:
//                                 Response::Vault(data, res_message_id),
//                             ..
//                         },
